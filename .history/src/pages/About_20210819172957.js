      ...
      <VStack align="stretch" width="100%">
        ...
        <Center>
          <Box
            ...
            height="225"
          >
            <Text textAlign="" color="white" fontFamily="monospace" padding="15px">
              Just like rockets connect different planets - Rocket connects to
              the IPFS across different browsers.
            </Text>
          </Box>
        </Center>
        <Spacer />
