    ...
    <Box width="350" height="400">
        ...
        {fileUrl && (
          <VStack>
            <Box paddingTop="4" boxSize="sm" width="350" height="200">
              ...
              />
              <Flex paddingTop="10">
                <ChakraLink href={fileUrl} isExternal>
                  <Button size="sm">View More Info</Button>
                </ChakraLink>
                <Spacer />
      ...
      >
        ...
        <ModalContent width="250">
          ...
          <ModalCloseButton />
          <ModalBody width="250">Select your provider :</ModalBody>
          <ModalFooter>
            <Button bgGradient="linear(to-b, #12395A, #6BC4CE) mr={3} onClick={onClose}>
              Close
            </Button>
